...
},
{
  ...
  "number": "7.4.2",
  "title": "",
  "body": "  Open main.py and look for the line class SinChnage(Scene): .  This particular block of code plots a transformed sine function of the form . Where initially . We then adjust the values for and over time.    Run the code to produce a video file.    Edit the array a=[1,2, 2, 2, -1\/3] , and the rhs entries to adjust the vertical stretch.    Edit the array b=[1,1, 1\/2,1\/2,-2] , and the rhs entries to adjust the horizontal stretch.    Edit the array c=[0,0, 0, -3, 2] , and the rhs entries to adjust the vertical shift.   "
},
{
